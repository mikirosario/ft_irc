...
/*   Updated: 2022/04/24 15:51:14 by mrosario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		send_rpl_CHANNELMODEIS(Client const & recipient, Channel const & channel, std::string const & modestring, std::string const & modeargs) const;
